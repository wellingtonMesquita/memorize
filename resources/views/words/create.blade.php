        ...
        <div class="row">
            ...
            <div class="card col-12">
                ...
                <div class="card-block">
                    ...
                    <form action="{{ route('words.store') }}" method="POST"  class="post-form">
                    @csrf
                        <div class="form-group row">
                            <label for="palavra_portugues" class="col-sm-2 col-form-label">Palavra Estrangeira</label>
                            <div class="col-sm-6">
                                <input id="foreign_words" name="foreign_words" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="palavra_ingles" class="col-sm-2 col-form-label">Tradução</label>
                            <div class="col-sm-6">
                                <input id="native_words" name="native_words" type="text" class="form-control" required>
                            </div>
                        </div>
                        <div class="col-sm-12">
